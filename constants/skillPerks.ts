/**
 * Client mirror of hatchly-server-2026/src/constants/skillPerks.ts
 * Used for skill detail UI and client-side minigame easing.
 */
...
export function backpackSlotsFromCraftingLevel(craftingLevel: number): number {
  return BASE_BACKPACK_SLOTS + sumPerkAmount('crafting', craftingLevel, 'backpack_slots');
}
