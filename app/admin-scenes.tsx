...
export default function AdminScenesScreen() {
  ...
  const styles = useMemo(
    () => StyleSheet.create({
      ...
      preview: { width: '100%' as any, height: 100, borderRadius: radius.md, backgroundColor: colors.surfaceElevated, marginTop: spacing.sm },
      ...
      input: { backgroundColor: colors.surfaceElevated, borderRadius: radius.md, paddingHorizontal: 12, paddingVertical: 8, color: colors.text, fontSize: 14, marginBottom: 8, borderWidth: 1, borderColor: colors.border },
